...
2. 데이터 탐색 후 보조하고자 하는 운동로 맨몸 운동인 푸쉬업과 스쿼트 선택
3. 
4. 유튜브 자세 영상에 알고리즘으로 사용할 변수들이 어떻게 변하는지 관찰
5. 관찰을 통해 간단한 푸쉬업 알고리즘만 구현
6. 푸쉬업 알고리즘 테스트 후 간단한 조정
7. 배포할 초기 단계 완성
8. aws ec2로 1차 배포
9. 도메인과 https까지 적용 완료
10. python으론 웹앱에서의 웹캠 서비스가 효과적이지 않은 것 같아 푸쉬업 알고리즘, 모델 사용, 웹캠 사용을 python 대신 js로 사용함
11. 간단한 스쿼트 알고리즘 추가하고 테스트 후 간단한 조정
12. 부트스트랩을 이용하여 프론트엔드 보충
